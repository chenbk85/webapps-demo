(function( App, $ ) {
    ...
    /**
     * Event类，结合App.event一起使用, 可以使任何对象具有事件行为。包含基本`preventDefault()`, `stopPropagation()`方法。
     ...
     * var obj = {};
     *
     * $.extend( obj, App.event );
     *
     * var etv = App.Event( 'beforeshow' );
     * obj.trigger( etv );
     *
     ...
     * }
     * ```
     * @grammar new App.Event( name[, props]) => instance
    ...
    App.event = {
         ...
         * @param  {String | Event }   evt     事件名或App.Event对象实例
         * @param  {*} * 任意参数
         * @return {self} 返回自身，方便链式
         * @chainable
         */
